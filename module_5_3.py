...
class House:
    houses_history = []    # Создаем список с историей построенных домов

# Вводим метод __new__ для добавления в список ключей новых созданных объектов
...
# КАК ЖЕ МНОГО ВРЕМЕНИ У МЕНЯ ПРОШЛО ЧТОБЫ ПОНЯТЬ ПРИНЦИП, ЛОГИКУ ЭТОЙ ТЕМЫ